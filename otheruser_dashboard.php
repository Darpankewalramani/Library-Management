...
td, a{
   ...
   include("data_class.php");
    ?>
           <div class="container">
            <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/header.png"/></div>
            <div class="leftinnerdiv">
                ...
                <a href="myindex.php"><Button class="greenbtn" > LOGOUT</Button></a>
            </div>
            ...
            padding: 8px;'>Name</th><th>Book Name</th><th>Issue Date</th><th>Return Date</th><th>Fine</th></th></tr>";
